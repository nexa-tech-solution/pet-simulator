...
import ORANGE_CAT from '@/assets/lotties/orange-cat.json';
import SNOOPY from '@/assets/lotties/snoopy.json';
import WHITE_PUPPY from '@/assets/lotties/white-puppy.json';

export const RIVES = {
  CAT: '/rive/cat.riv',
  GREY_CAT: '/rive/grey-cat.riv',
  HAPPY_DOG: '/rive/happy-dog.riv',
};
