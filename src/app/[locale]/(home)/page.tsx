...
export default async function HomePage() {
  return (
    <div
      className='flex flex-col min-h-screen w-full overflow-hidden transition-colors duration-1000 bg-linear-to-b from-sky-300 via-blue-100 to-white dark:from-slate-800 dark:to-slate-900'
