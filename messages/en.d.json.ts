...
declare const messages: {
  ...
  "home": {
    ...
    "reward": {
      "title": "Your Chance!",
      "subtitle": "Watch a short video ad and you might win",
      "watch": "Watch Video",
      "watchHint": "Watch the ad to get your reward!",
      "loading": "Loading ad...",
      "congrats": "Congratulations!",
      "wonPrefix": "You've won",
      "wonAmount": "{coins} coins!",
      "unavailable": "No ad right now",
      "close": "Close"
    }
  },
  "pets": {
  ...
  "chat": {
    ...
    "earnCoinsHint": "Feed (+5), play (+10) or let {name} sleep (+15) on the home screen to earn coins.",
    "goEarnCoins": "Go earn coins",
    "clearChat": "Clear chat",
    "clearChatTitle": "Clear chat?",
    "clearChatMessage": "This permanently deletes your conversation with {name}. It cannot be undone."
  },
  "settings": {
    "title": "Settings",
    ...
    "sound": "Sound Effects",
    "soundHint": "Every pet has its own voice",
    "volume": "Volume",
    "off": "Off",
